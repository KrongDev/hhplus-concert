...
import com.hhplusconcert.infra.point.orm.PointHistoryJpoRepository;
...
public class PointHistoryRepositoryImpl implements PointHistoryRepository {
    //
    private final PointHistoryJpoRepository pointHistoryJpoRepository;

    @Override
    public void save(PointHistory pointHistory) {
        //
        this.pointHistoryJpoRepository.save(new PointHistoryJpo(pointHistory));
    }

    @Override
    public List<PointHistory> findAll(String userId) {
        List<PointHistoryJpo> histories = this.pointHistoryJpoRepository.findAllByUserId(userId);
